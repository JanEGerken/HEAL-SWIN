...
class ValidateSwinDepthMlflowTrainRun(ValidateMlflowTrainRun):
    def __init__(self, slurm_path):
        ...
        self.params += [
            ...
            "swin_transformer_config.norm_layer",
        ...
        self.files += ["depth_swin_test_run_config.py"]
...
def test_swin_training():
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        command = (
            ...
            "heal_swin/testing/depth_swin_test_run_config.py"
        )
        command += f" > {tmpfile}"
        ...
        mlflow_validator = ValidateSwinDepthMlflowTrainRun(tmpfile)
