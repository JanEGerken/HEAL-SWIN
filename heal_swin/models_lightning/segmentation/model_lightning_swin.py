...
@dataclass
class WoodscapeSegmenterSwinConfig:
...
class WoodscapeSegmenterSwin(pl.LightningModule):

    CONFIG_CLASS = WoodscapeSegmenterSwinConfig
    NAME = "swin"
    ...
    def __init__(self, config, data_spec: DataSpec, data_config):
        ...
        self.model = swin_transformer.SwinTransformerSys(
            config.swin_transformer_config, data_spec=data_spec
        )
